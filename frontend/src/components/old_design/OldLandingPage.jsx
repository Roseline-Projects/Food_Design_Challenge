    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-cream font-nunito">
      ...
      <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
        ...
        <p className="text-dark-green mb-8 max-w-xl font-nunito">
          Save more, shop less, and make the most of what you've got with our food budgeting tools. We'll make the best of what you already have.
        </p>
        <div className="mt-auto h-96 w-full flex items-center justify-center bg-light-yellow rounded-lg">
          {/* 3D Model container */}
          <p className="text-dark-green font-nunito">Hero Decor Placeholder</p>
        </div>
      </div>
