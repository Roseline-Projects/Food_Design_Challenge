  ...
  return(
    <div className="pt-12 bg-orange-300">
      <div className="relative bg-orange-300 pb-6 lg:pb-0">
        <h1 className="lg:absolute top-18 left-0 pl-18 px-12 text-7xl font-bold">Let's Get Started</h1>
        <svg className="hidden lg:block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 319"><path fill="#fff" fill-opacity="1" d="M0,288L80,282.7C160,277,320,267,480,240C640,213,800,171,960,160C1120,149,1280,171,1360,181.3L1440,192L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
...
const DuringSection = () => {
  return(
    <section className="bg-white shadow-sm p-12 my-14 rounded-2xl">
      ...
      <div className="bg-green-100 rounded-2xl px-10 py-16 flex items-center gap-10 shadow-sm">
        <div className="size-[54px] rounded-full">
...
const StepCard = ({header, para, number}) => {
  return (
    <div className="grid grid-cols-4 items-center p-1 gap-10">
      <div>
        <h4 className="text-8xl text-right text-orange mx-6">{number}</h4>
      </div>
...
const AfterSection = () => {
  return(
    <section className="bg-white shadow-sm p-12 my-14 rounded-2xl">
      ...
      {console.log(Object.entries(stepCardInfo))}
      <div>
